...
PROVIDER_TYPES: list[dict[str, Any]] = [
    ...
    },
    {
        "id": "xiaomi_mimo",
        "name": "Xiaomi MiMo",
        "description": "Xiaomi MiMo open-weight models",
        "default_base_url": "https://api.xiaomimimo.com/v1",
        "discovery": "openai",
        "protocol": "openai",
        "docs_url": "https://api.xiaomimimo.com/docs",
        "group": "Open model clouds",
        "fields": [
            {"name": "api_key", "label": "API key", "type": "secret", "required": True},
            {"name": "base_url", "label": "Base URL", "type": "url", "required": True},
    ...
    {
        "id": "xiaomi_coding_plan",
        "name": "Xiaomi MiMo Coding Plan",
        "description": "Xiaomi token-plan coding endpoint",
    ...
    },
    {
        "id": "zai",
        "name": "Z.AI",
        "description": "Zhipu Z.AI platform API",
    ...
    },
    {
        ...
        "description": "Zhipu Z.AI coding plan endpoint",
    ...
    },
    {
        "id": "together",
        "name": "Together AI",
        "description": "Together AI inference cloud",
    ...
    },
    {
        "id": "fireworks",
        "name": "Fireworks AI",
        "description": "Fireworks inference platform",
    ...
    },
    {
        "id": "siliconflow",
        "name": "SiliconFlow",
        "description": "SiliconFlow model cloud",
    ...
    },
    {
        "id": "volcengine_ark",
        "name": "Volcengine Ark",
        "description": "Volcengine Ark (ByteDance)",
...
""")
    ...
    def create(self, config: dict[str, Any]) -> dict[str, Any]:
        ...
        if provider_type == "custom":
            ...
            # OpenAI-compatible discovery defaults so a preset connection
            # (deepinfra, xiaomi, zai, ...) works without filling in the
            # model-list plumbing manually.
            merged.setdefault("models_field", "data")
            merged.setdefault("model_id_field", "id")
            merged.setdefault("extra_headers_json", "{}")
            merged.setdefault("extra_body_json", "{}")
